...
export default function RNRCricket() {
  ...
  const css = `
    @import url('https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Outfit:wght@300;400;500;600;700;800&family=Racing+Sans+One&display=swap');
  ...
  return (
    <div style={{ fontFamily: "'Outfit',sans-serif", background: B.lightGray, minHeight: "100vh" }}>
      ...
      {/* ═══ HOME ═══ */}
      {page === "home" && <div>
        <section style={{ minHeight: "100vh", background: `linear-gradient(180deg,${B.deepNavy} 0%,${B.navy} 50%,${B.deepNavy} 100%)`, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden", paddingTop: 64 }}>
          <div style={{ position: "absolute", inset: 0, background: `radial-gradient(circle at 30% 40%,rgba(226,32,60,0.06) 0%,transparent 50%),radial-gradient(circle at 70% 60%,rgba(10,22,40,0.9) 0%,transparent 50%)` }}/>
          <div style={{ position: "absolute", top: "20%", left: 0, width: "150%", height: 1, background: `${B.red}10`, transform: "rotate(-8deg)" }}/>
          <div style={{ position: "absolute", top: "70%", left: "-20%", width: "150%", height: 1, background: `${B.red}10`, transform: "rotate(5deg)" }}/>
          <div style={{ position: "relative", zIndex: 2, textAlign: "center", padding: "2rem", opacity: heroReady ? 1 : 0, transform: heroReady ? "translateY(0)" : "translateY(40px)", transition: "all 1s cubic-bezier(0.16,1,0.3,1)" }}>
            ...
            <div style={{ display: "inline-flex", alignItems: "center", gap: 16, marginTop: 12 }}>
              <div style={{ width: 40, height: 2, background: B.red }}/>
              <span style={{ fontFamily: "'Racing Sans One',sans-serif", fontSize: "clamp(1rem,2vw,1.4rem)", color: B.red, letterSpacing: "0.08em" }}>Take Your Game to the Next Level</span>
              <div style={{ width: 40, height: 2, background: B.red }}/>
            </div>
      ...
      {page === "about" && <div style={{ paddingTop: 64 }}>
        <section style={{ background: `linear-gradient(135deg,${B.deepNavy} 0%,${B.navy} 100%)`, padding: "80px 24px", textAlign: "center" }}>
          ...
          <p style={{ fontFamily: "'Racing Sans One',sans-serif", color: B.silver, fontSize: 18, marginTop: 8 }}>Cayman Islands' Premier Cricket Store</p>
        </section>
